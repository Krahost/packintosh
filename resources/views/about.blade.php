...
<!-- Mirrored from html.creativegigstf.com/babun/babun/# by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 11:08:42 GMT -->
<head>
	<meta charset="UTF-8">
					...
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
							<ul class="d-flex align-items-center style-none">
								<li class="d-none d-md-block"><a href="#" class="btn-one tran3s">Get in Touch</a></li>
							</ul>
						</div> <!--/.right-widget-->
						<nav class="navbar navbar-expand-lg p0 order-lg-2">
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									...
									<li class="d-md-none ps-2 pe-2"><a href="#" class="btn-one w-100 mt-15 tran3s">Get in Touch</a></li>
								</ul>
							</div>
						</nav>
					</div>
				...
				<div class="line-wrapper position-relative">
                    <div class="row align-items-center">
                        <div class="col-lg-5 wow fadeInLeft">
                            ...
                            <a href="#" class="btn-three icon-link mt-15 md-mb-40">
			...
			<div class="container">
				<div class="position-relative">
					...
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-6 d-flex wow fadeInUp">
							<div class="card-style-two vstack tran3s w-100 mt-30">
								...
								<a href="#" class="arrow-btn tran3s mt-auto stretched-link"><img src="images/lazy.svg" data-src="images/icon/icon_09.svg" alt="" class="lazy-img"></a>
							</div>
							<!-- /.card-style-two -->
						</div>
					...
					<div class="section-subheading sm-mt-40">
						...
						<a href="#" class="btn-three icon-link">
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-xxl-5 col-lg-6 ms-auto d-flex flex-column order-lg-last wow fadeInRight">
						...
						<div><a href="#" class="btn-four mt-15">Let’s Talk</a></div>
					...
					<div class="row">
						<div class="col-lg-8">
							...
							<div class="block-one pt-45 lg-pt-30 pb-20 ps-3 ps-xl-5 pe-xl-5 pe-3 position-relative border-30 wow fadeInUp">
								<div class="row">
									...
									<div class="col-lg-7">
										<h3 class="block-title d-inline-block position-relative"><a href="#">Manage your online banking and get rewarded</a></h3>
									</div>
								</div>
							</div>
							<!-- /.block-one -->
						...
						<div class="col-lg-4">
							<div class="block-three border-30 ps-lg-4 ps-3 pe-lg-4 pe-3 pt-40 lg-pt-30 pb-30 md-mt-30 wow fadeInUp" data-wow-delay="0.2s">
								...
								<h3 class="block-title d-inline-block position-relative mt-20 mb-80 lg-mb-50"><a href="#">Gold card user will get priority pass for Airport.</a></h3>
								<div class="d-flex align-items-center justify-content-between">
							...
							<div class="block-four border-30 ps-lg-4 ps-3 pe-lg-4 pe-3 pt-15 pb-30 mt-45 lg-mt-30 wow fadeInUp" data-wow-delay="0.2s">
								<h3 class="block-title d-inline-block position-relative mt-20 mb-250 lg-mb-150 sm-mb-100"><a href="#">Our Travel Card Makes <br class="d-none d-xl-block">you Happy.</a></h3>
								<div class="d-flex align-items-center justify-content-between">
									<div class="tag text-uppercase fw-500">DESIGN</div>
									<a href="#" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
								</div>
			...
			<div class="container">
				<div class="row align-content-center">
					...
					<div class="col-lg-4 col-md-3">
						<a href="#" class="quote-btn color-two tran5s rounded-circle d-flex align-items-center justify-content-center ms-auto">
            ...
            <div class="container">
                <div class="main-wrapper bottom-border">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <form action="#" class="m-auto ms-lg-auto">
                                <div class="d-flex align-items-center justify-content-between">
...
<!-- Mirrored from html.creativegigstf.com/babun/babun/# by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 11:08:43 GMT -->
</html>